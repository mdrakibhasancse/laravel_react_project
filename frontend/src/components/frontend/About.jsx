        ...
        <div>
            <Header></Header>
              <main>
                ...
                <Hero preHeading='Quality ,Intergety, Value' heading='About Us' 
                text="Lorem ipsum dolor sit amet consectetur adipisicing elit. <br />
                Totam architecto ea deserunt tempora? Quibusdam corporis sed dolorum! Earum, ratione beatae."></Hero>

                <AboutSection></AboutSection>
                
                <div className="our-team bg-light py-5">
